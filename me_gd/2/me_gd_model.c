...
me_gd_dev_cmd_set_t me_gd_models_cmd_set[] = {
        ...
        { // 0213B74
            .init   =   {
                { 0x01, me_str("\249\000\000")}, // (height-1)%256,height-1)/256
                { 0x11, me_str("\x11")},
                { 0x44, me_str("\x00\015")}, // 00,width/8-1
                { 0x45, me_str("\249\000\000\000")}, // (height-1)%256,height-1)/256
                { 0x3C, me_str("\x05")},
                { 0x21, me_str("\x00\x80")},
                { 0x4E, me_str("\x00")},
                { 0x4F, me_str("\249\000")}, // (height-1)%256,height-1)/256
