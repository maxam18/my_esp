 ...
 */
esp_err_t me_soled_init(me_ssd1306_conf_t *conf);
 ...
 *     - ESP_ERR_*  returned by me_i2c_read
 */
esp_err_t me_soled_display_clear(me_ssd1306_conf_t *conf);
 ...
 *     - ESP_ERR_*  returned by me_i2c_read
 */
esp_err_t me_soled_contrast(me_ssd1306_conf_t *conf, int contrast);
 ...
 *     - ESP_ERR_*  returned by me_i2c_read
 */
esp_err_t me_soled_8x8_string(me_ssd1306_conf_t *conf, char *str, int row);
